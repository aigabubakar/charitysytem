...
class Portfolio_2_Column extends Widget_Base {
	...
	public function get_name() {
		return 'purehearts_portfolio_2_column';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio 2 Column', 'purehearts' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_2_column',
			[
				'label' => esc_html__( 'Portfolio 2 Column', 'purehearts' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                <figure class="image-box"><a href="<?php echo esc_url($post_thumbnail_url);?>" class="lightbox-image" data-fancybox="gallery"><?php the_post_thumbnail('purehearts_570x570'); ?></a></figure>
            </div>   
