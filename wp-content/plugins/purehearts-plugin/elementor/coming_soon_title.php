 ...
 * @since 1.0.0
 */
class Coming_Soon_Title extends Widget_Base {
	...
	public function get_name() {
		return 'purehearts_coming_soon_title';
	}
	...
	public function get_title() {
		return esc_html__( 'Coming Soon Title', 'purehearts' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'coming_soon_title',
			[
				'label' => esc_html__( 'Coming Soon Title', 'purehearts' ),
			]
		);
		$this->add_control(
            'pattern',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Event Name', 'purehearts' ),
			]
		);
		$this->add_control(
			'title',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Reminder', 'purehearts' ),
			]
		);
		$this->add_control(
			'btn_link',
