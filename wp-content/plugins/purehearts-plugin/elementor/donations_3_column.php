 ...
 * @since 1.0.0
 */
class Donations_3_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'purehearts_donations_3_column';
    }
    ...
    public function get_title() {
        return esc_html__( 'Donations 3 Column', 'purehearts' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'donations_3_column',
            [
                'label' => esc_html__( 'Donations 3 Column', 'purehearts' ),
			]
        );
		$this->add_control(
            'text_limit',
