...
class Slider_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slider V2', 'purehearts' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'slider_v2',
            [
                'label' => esc_html__( 'Slider V2', 'purehearts' ),
            ]
        );
		$this->add_control(
              'slides', 
			  	[
            		...
            		'default' => 
						[
                			['title' => esc_html__('Adopt a Child', 'purehearts')],
                			['title' => esc_html__('Spread Joy', 'purehearts')],
							['title' => esc_html__('Good Souls', 'purehearts')],
            			],
            		'fields' => 
						[
							[
                ...
                <div class="swiper-container banner-content">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <?php if($item['bg_image']['id']): ?><div class="image-layer" style="background-image: url(<?php echo esc_url(wp_get_attachment_url($item['bg_image']['id'])); ?>);"></div><?php endif; ?>
                            <div class="auto-container">
                                <div class="content-box">
                                    <?php if($item['pattern']){ ?>
                                    <figure class="icon-layer"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/heart-5.png" alt="<?php esc_attr_e('Awesome Image', 'purehearts'); ?>"></figure>
                                    <div class="shape" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape-31.png);"></div>
                                    <?php } ?>
