 ...
 * @since 1.0.0
 */
class Donations_2_Column extends Widget_Base {
    ...
    public function get_name() {
        return 'purehearts_donations_2_column';
    }
    ...
    public function get_title() {
        return esc_html__( 'Donations 2 Column', 'purehearts' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'donations_2_column',
            [
                'label' => esc_html__( 'Donations 2 Column', 'purehearts' ),
			]
        );
        $this->add_control(
            'query_number',
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-three">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><?php the_post_thumbnail('purehearts_570x420')?></figure>
                                    <div class="text">
