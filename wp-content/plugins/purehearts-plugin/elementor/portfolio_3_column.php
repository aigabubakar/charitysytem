...
class Portfolio_3_Column extends Widget_Base {
	...
	public function get_name() {
		return 'purehearts_portfolio_3_column';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio 3 Column', 'purehearts' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_3_column',
			[
				'label' => esc_html__( 'Portfolio 3 Column', 'purehearts' ),
			]
		);
		$this->add_control(
			'number',
		...
		<?php 
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                <div class="portfolio-block-one">
                    <div class="inner-box">
                        <figure class="image"><?php the_post_thumbnail('purehearts_370x370'); ?></figure>
