...
namespace PUREHEARTSPLUGIN\Inc\Post_Types;

use PUREHEARTSPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  PUREHEARTSPLUGIN/Abstracts
...
class Testimonials extends Post_Type {
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wppurehearts' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wppurehearts' );
