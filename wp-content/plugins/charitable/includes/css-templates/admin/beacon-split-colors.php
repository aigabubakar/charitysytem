...
/**
 * Beacon Split — admin color overrides.
 *
 * Color-specific CSS for the admin builder preview. Theme color CSS variables
 * are already declared in the main beacon-split.php; this file exists so that
...
.charitable-preview.charitable-builder-template-beacon-split #charitable-design-wrap .charitable-campaign-preview {
