...
return  array(
    'title'      => esc_html__( 'Search Page Settings', 'purehearts' ),
    'id'         => 'search_setting',
    'desc'       => '', 
    'subsection' => true,
    'fields'     => array(
	    array(
		    ...
		    'type'    => 'button_set',
		    'title'   => esc_html__( 'Search Source Type', 'purehearts' ),
		    'options' => array(
	    ...
	    array(
		    ...
		    'type'     => 'section',
		    'title'    => esc_html__( 'Search Default', 'purehearts' ),
		    'indent'   => true,
	    ...
	    array(
		    ...
		    'default'  => array(
			    'url' => PUREHEARTS_URI . 'assets/images/resources/breadcrumb-bg.jpg',
		    ),
		    'required' => array( 'search_page_banner', '=', true ),
	    ),
