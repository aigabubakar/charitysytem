 ...
 */
//purehearts_load_default_hooks
function purehearts_load_default_hooks() {

	$config = purehearts_WSH()->config( 'default' );
...
//purehearts_preloader
function purehearts_preloader() {
...
/**
 * [purehearts_main_header_area description]
 *
 * @return [type] [description]
 */

//purehearts_main_header_area
function purehearts_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		purehearts_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		purehearts_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		purehearts_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		purehearts_template_load( 'templates/header/header_v4.php' );
	} else {
		purehearts_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [purehearts_main_footer_area description]
 *
 * @return [type] [description]
 */
//purehearts_main_footer_area
function purehearts_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		purehearts_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		purehearts_template_load( 'templates/footer/footer_v2.php' );
	} else {
		purehearts_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [purehearts_sidebar description]
 *
 * @return [type] [description]
 */
//purehearts_sidebar
function purehearts_sidebar( $data ) {

	purehearts_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [purehearts_banner description]
 *
 * @return [type] [description]
 */
//purehearts_banner
function purehearts_banner( $data ) {

	purehearts_template_load( 'templates/banner/banner.php', compact( 'data' ) );
