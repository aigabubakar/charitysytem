...
<div class="boxed_wrapper">
    ...
    <header class="main-header header-style-one">
                ...
                <div class="top-inner clearfix">
                    <div class="left-column pull-left">
                        <ul class="info-list clearfix">
                            ...
                            <li>
                                ...
                                <a href="tel:<?php echo esc_attr($options->get('phone_no_v3')); ?>"><?php echo wp_kses($options->get('phone_no_v3'), true); ?></a>
                            </li>
                            <?php } ?>
                            <?php if( $options->get('email_address_v3') ){?>
                            <li>
                                <a href="mailto:<?php echo esc_attr($options->get('email_address_v3')); ?>"><?php echo wp_kses($options->get('email_address_v3'), true); ?></a>
                            </li>
                            <?php } ?>
                            <?php if( $options->get('address_v3') ){?>
                            <li>
                                <?php echo wp_kses($options->get('address_v3'), true); ?>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="right-column pull-right">
                        <div class="update-news">
                            <p><i class="icon-megaphone"></i><?php echo wp_kses($options->get('welcome_text_v3'), true); ?></p>
                        </div>
                    </div>
                    <?php } ?>
                </div>
            </div>
            <?php if( $options->get('show_donate_btn_v3') ){?>
            <!-- donate-btn -->
            <div class="donate-btn">
                <button class="donate-box-btn theme-btn btn-one"><?php echo wp_kses($options->get('btn_title_v3'), true); ?></button>
            </div>
            <?php } ?>
        </div>
        <?php } ?>
        ...
        <div class="header-lower">
            <div class="outer-container">
                <div class="outer-box">
                    <?php if( $options->get('volunteer_text_v3') ){?> 
                    <div class="text">
                        <a href="<?php echo esc_url( $options->get( 'vol_link3' ) );?>">
                        ...
                        <span><?php echo wp_kses($options->get('volunteer_text_v3'), true); ?></span>
                        </a>
                    </div>
                    <?php } ?>
                    ...
                    <div class="nav-right-content clearfix">
                        ...
                        <?php if( $options->get('show_cart_icon_v3') ){?>
                        ...
                        <?php if( $options->get('show_sidebar_icon_v3') ){?>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <?php if( $options->get('address_v3') || $options->get('phone_no_v3') || $options->get('email_address_v3') ){?>
            <div class="contact-info">
                <?php if($options->get('info_title_v3')){ ?><h4><?php echo wp_kses($options->get('info_title_v3'), true); ?></h4><?php } ?>
                <ul>
                    <?php if( $options->get('address_v3') ){ ?><li><?php echo wp_kses($options->get('address_v3'), true); ?></li><?php } ?>
                    <?php if( $options->get('phone_no_v3') ){ ?><li><a href="tel:<?php echo esc_attr($options->get('phone_no_v3')); ?>"><?php echo wp_kses($options->get('phone_no_v3'), true); ?></a></li><?php } ?>
                    <?php if( $options->get('email_address_v3') ){ ?><li><a href="mailto:<?php echo esc_attr($options->get('email_address_v3')); ?>"><?php echo wp_kses($options->get('email_address_v3'), true); ?></a></li><?php } ?>
                </ul>
            </div>
            <?php } ?>
			<?php 
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        ...
                        <div class="content-box">
                            <h4><?php echo wp_kses($options->get('sidebar_info_title_v3'), true); ?></h4>
                            <p><?php echo wp_kses($options->get('sidebar_info_text_v3'), true); ?></p>
                        </div>
                        <div class="form-inner">
                            <h4><?php echo wp_kses($options->get('sidebar_form_title_v3'), true); ?></h4>
                            <?php echo do_shortcode($options->get('sidebar_contact_form_url_v3')); ?>
                        </div>
                    </div>
                </div>
            </div>
